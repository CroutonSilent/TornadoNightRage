...
void save_callback()
{
	...
	std::string config_directory = "C:\\8362342\\cfg\\";
	...
	interfaces::cvar->ConsoleColorPrintf(Color(140, 10, 250, 255), "TornadoNight ");
...
void load_callback()
{
	...
	interfaces::cvar->ConsoleColorPrintf(Color(140, 10, 250, 255), " TornadoNight.xyz ");
...
void list_configs() {
	...
	file_in.open("C:\\8362342\\cfg\\tornadonight_configs.txt");
	if (file_in.fail()) {
		std::ofstream("C:\\8362342\\cfg\\tornadonight_configs.txt");
		file_in.open("C:\\8362342\\cfg\\tornadonight_configs.txt");
	}
	int line_count;
	while (!file_in.eof()) {
...
void add_config() {
	std::fstream file;
	file.open("C:\\8362342\\cfg\\tornadonight_configs.txt", std::fstream::app);
	if (file.fail()) {
		std::fstream("C:\\8362342\\cfg\\tornadonight_configs.txt");
		file.open("C:\\8362342\\cfg\tornadonight_configs.txt", std::fstream::app);
	}
...
void remove_config() {
	...
	std::ofstream ofs("C:\\8362342\\cfg\\tornadonight_configs.txt", std::ios::out | std::ios::trunc);
	ofs.close();
	std::fstream file;
	file.open("C:\\8362342\\cfg\\tornadonight_configs.txt", std::fstream::app);
	if (file.fail()) {
...
#pragma region Aimbot
	...
	resolver.AddItem("TornadoNight.xyz primary");
...
//	AntiAimYaw.AddItem("Twist");
	...
	fl_spike.AddItem("TornadoNight.xyz adaptive");
